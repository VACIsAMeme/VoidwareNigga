...
void Menu::DoUIFrame()
{
	...
	if (Window.MiscTab.DisableAll.GetState())
	{
		...
		Window.LegitBotTab.AimbotEnable.SetState(false);
		Window.LegitBotTab.AimbotAutoFire.SetState(false);
		Window.LegitBotTab.AimbotAutoPistol.SetState(false);
		Window.LegitBotTab.TriggerEnable.SetState(false);
